...
func main() {
    var (
        ...
        poolName            = flag.String("phpfpm.pool-name", "www", "phpfpm's pool name")
        listenKey           = flag.String("phpfpm.listen-key", "127.0.0.1:9000", "phpfpm's listen address")
        statusKey           = flag.String("phpfpm.status-key", "/status", "phpfpm's status path")
